...
var orderSureObj = {
    ...
    initPageItem: function(pigeonsInfoArr) {
        ...
        pigeonsInfoArr.forEach(function(val, index) {
            initStr += '<div class="order_item_list">' +
                ...
                '<a href="javascript:;">Andreas Drapa</a>' +
                '</span>' +
                '</label>' +
                '</div>' +
    ...
    initPageUl: function(pigeonArr) {
        var ulStr = "";
        pigeonArr.forEach(function(val) {
            ulStr += '<li class="item-single clearfix">' +
                ...
                '<p>' + val.pigeonPoint + '</p>' +
                '<p class="item_from_pic">¥' + val.pigeonPrice + '</p>' +
                '</div>' +
                '</div>' +
                '</li>';
        })
