...
var orderListObj = {
    initRequest: function(postData) { //
        $.ajax({
            url: location.origin + "/business/orderitem/findList",
            type: "post",
    ...
    /**
     * 28、发货提醒接口（消息发送接口）
     * http://域名/business/message/sendDeliveryReminding
     */
    sendGoodsMsg: function(sendGoodsData, callback) {
        $.ajax({
            url: location.origin + "/business/message/sendDeliveryReminding",
            type: "post",
     ...
     * 51、确认卖家发货
     * 待发货 
     * http://域名/business/orderitem/confirmBusinessDelivery
     */
    sendSureGoodsMsg: function(sureSendData, callback) {
        $.ajax({
            url: location.origin + "/business/orderitem/confirmBusinessDelivery",
            type: "post",
