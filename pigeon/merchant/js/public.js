...
/*身份证号校验*/
function validateUser($that) {
    var cardistrue = true;
    var timer = null;
    var userCardValue = $that.val().trim();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.code == "0") {
                ...
                if (businessObj && businessObj.shopName) {
                    var shopName = businessObj.shopName || "";
                    callback && callback(shopName);
                } else {
                    callback && callback("");
                }
            } else {
